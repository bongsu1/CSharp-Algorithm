namespace _01._List
{
    internal class Program
    {
        ...
        *******************************************************/
        ...
        {
            List<int> list1 = new List<int>(100000/*capacity*/);
            //list1.Capacity = 100000;           // 리스트 실제크기
            for (int i = 0; i < 100000; ++i)
            {
                list1.Add(i); // 크기를 처음에 설정하지 않으면 계속 만들고 복사를 반복하여 느려짐
            }



            //int[] array = new int[5];               // 크기 고정
            List<string> list = new List<string>(); // 크기가 유동적이다
            ...
            bool fail = list.Remove("6번째 데이터"); // 없으면 못지움 (반환형 bool) 지우는데 성공:true 실패:false
