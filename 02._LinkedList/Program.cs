...
namespace _02._LinkedList
{
    internal class Program
    {
        ...
        // 하지남, 데이터의 접근 과정에서 연속적인 데이터 배치가 아니기 때문에 인덱스 사용이 불가하여 처음부터 탐색해야 함
        ...
        static void Main(string[] args)
        {
            ...
            // 삽입
            LinkedListNode<string> node0 = linkedList.AddFirst("0번데이터");
            LinkedListNode<string> node1 = linkedList.AddFirst("1번데이터");
            LinkedListNode<string> node2 = linkedList.AddLast("2번데이터");
            LinkedListNode<string> node3 = linkedList.AddLast("3번데이터");
            LinkedListNode<string> Node4 = linkedList.AddBefore(node0, "0번 앞에 데이터");
            LinkedListNode<string> Node5 = linkedList.AddAfter(node0, "0번 뒤에 데이터");

            // 삭제
            bool sucess = linkedList.Remove("1번 데이터");
            bool fail = linkedList.Remove("1번 데이터");  // 탐색을 하기 때문에 속도가 느리다
            linkedList.Remove(node3);                    // 속도가 빠르다
            ...
            LinkedListNode<string> next = node0.Next;  // 참조되어 있는 노드위치에 삽입되거나 삭제되면 값이 바뀔 수 있다
